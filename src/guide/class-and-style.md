...
If your component has multiple root elements, you would need to define which element will receive this class. You can do this using `$attrs` component property:
...
You can learn more about component attribute inheritance in [Component Props](component-attrs.html#non-prop-attributes) section.
